...
import 'package:mycampus/screens/personal_data_page/local_widgets/personality_card_widget.dart';
  ...
  Padding _buildQuestionCard(PersonalityQuestionModel questionData, int index) {
    return Padding(
      ...
      child: PersonalityCardWidget(
        questionLeft: questionData.questionLeft,
        questionRight: questionData.questionRight,
